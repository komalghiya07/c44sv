...
function preload(){
  ...
  aboutUsImage=loadImage("aboutUs.png");
  helpImage=loadImage("help.png");
  lifeImage=loadImage("help.png");
...
function setup() {
  ...
  aboutUs=createSprite(75,700,50,50);
  aboutUs.addImage("us",aboutUsImage);
  aboutUs.scale=0.3;

  help=createSprite(1555,700,50,50);
...
function draw() {
  ...
  if(mousePressedOver(help)){
    ...
    reset.visible=false;
     ...
     if(bird.collide(balloonGroup,hotairballoonGroup,shipGroup,stoneGroup)){
       life===2;
     }
  bird.collide(edges);
  drawSprites();
